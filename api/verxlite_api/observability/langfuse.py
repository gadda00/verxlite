...
class LangfuseTracer:
    ...
    def trace_workflow_step(
        ...
        observation = self.langfuse.observation(
            id=step_id,
            trace_id=run_id,
    ...
    def _sanitize_prompt(self, text: str) -> str:
        ...
        text = re.sub(r'\b\d{1,5}\s[\w\s]{1,20}(?:street|st|avenue|ave|road|rd|highway|hwy|square|sq|trail|trl|drive|dr|court|ct|parkway|pkwy|circle|cir|boulevard|blvd)\b', '[ADDRESS]', text, flags=re.IGNORECASE)
